...
Message LoRaModule::receiveMessage(uint32_t timeout_ms, Message::Type type = Message::Type::ALL, size_t repeat_attempts = 0, MACAddress source = nullptr, bool promiscuous = false)
{
    if (source == nullptr)
